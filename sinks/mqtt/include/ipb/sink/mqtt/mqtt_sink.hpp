...
public:
    ...
    common::Result<void> publish_message(const std::string& topic, const std::string& payload,
...
public:
    static std::unique_ptr<MQTTSink> create_high_throughput(
        const std::string& broker_url, const std::string& base_topic = "ipb/data");

    static std::unique_ptr<MQTTSink> create_low_latency(const std::string& broker_url,
                                                        const std::string& base_topic = "ipb/data");

    static std::unique_ptr<MQTTSink> create_reliable(const std::string& broker_url,
                                                     const std::string& base_topic = "ipb/data");

    static std::unique_ptr<MQTTSink> create_secure(const std::string& broker_url,
