...
#endif
#elif defined(IPB_ARCH_X86) || defined(IPB_ARCH_X86_64) || defined(IPB_ARCH_ARM) || \
    defined(IPB_ARCH_ARM64)
#define IPB_LITTLE_ENDIAN 1
#else
...
constexpr PlatformInfo get_platform_info() noexcept {
    return PlatformInfo{.os_name          = IPB_OS_NAME,
