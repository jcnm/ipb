...
constexpr std::string_view error_name(ErrorCode code) noexcept {
    switch (code) {
        ...
        case ErrorCode::POSTCONDITION_FAILED:
        ...
        case ErrorCode::HOST_UNREACHABLE:
        ...
        case ErrorCode::IO_SOCKET_ERROR:
            return "IO_SOCKET_ERROR";
        case ErrorCode::RESOURCE_MEMORY_ALLOCATION_FAILED:
            return "RESOURCE_MEMORY_ALLOCATION_FAILED";
        ...
        case ErrorCode::TOO_MANY_HANDLES:
            return "TOO_MANY_HANDLES";
        case ErrorCode::HANDLE_INVALID:
            return "HANDLE_INVALID";
        case ErrorCode::POOL_EXHAUSTED:
        ...
        case ErrorCode::CERTIFICATE_UNTRUSTED:
        ...
        case ErrorCode::SECURITY_SSL_INIT_FAILED:
            return "SECURITY_SSL_INIT_FAILED";
        case ErrorCode::SECURITY_CERTIFICATE_INVALID:
            return "SECURITY_CERTIFICATE_INVALID";
        case ErrorCode::SECURITY_KEY_INVALID:
            return "SECURITY_KEY_INVALID";
        case ErrorCode::SECURITY_HANDSHAKE_FAILED:
            return "SECURITY_HANDSHAKE_FAILED";
        case ErrorCode::SECURITY_CRYPTO_ERROR:
            return "SECURITY_CRYPTO_ERROR";

        // Routing
        case ErrorCode::ROUTE_NOT_FOUND:
            return "ROUTE_NOT_FOUND";
        case ErrorCode::RULE_NOT_FOUND:
            return "RULE_NOT_FOUND";
        case ErrorCode::RULE_INVALID:
            return "RULE_INVALID";
        case ErrorCode::RULE_CONFLICT:
            return "RULE_CONFLICT";
        case ErrorCode::SINK_NOT_FOUND:
            return "SINK_NOT_FOUND";
        case ErrorCode::SINK_UNAVAILABLE:
            return "SINK_UNAVAILABLE";
        case ErrorCode::SINK_OVERLOADED:
            return "SINK_OVERLOADED";
        case ErrorCode::ALL_SINKS_FAILED:
            return "ALL_SINKS_FAILED";
        case ErrorCode::ROUTING_LOOP:
            return "ROUTING_LOOP";
        case ErrorCode::NO_MATCHING_RULE:
            return "NO_MATCHING_RULE";
        case ErrorCode::PATTERN_INVALID:
            return "PATTERN_INVALID";
        case ErrorCode::DEAD_LETTER_FULL:
            return "DEAD_LETTER_FULL";

        // Scheduling
        case ErrorCode::DEADLINE_MISSED:
            return "DEADLINE_MISSED";
        case ErrorCode::TASK_CANCELLED:
            return "TASK_CANCELLED";
        case ErrorCode::TASK_FAILED:
            return "TASK_FAILED";
        case ErrorCode::SCHEDULER_STOPPED:
            return "SCHEDULER_STOPPED";
        case ErrorCode::SCHEDULER_OVERLOADED:
            return "SCHEDULER_OVERLOADED";
        case ErrorCode::PRIORITY_INVALID:
            return "PRIORITY_INVALID";
        case ErrorCode::TIMING_CONSTRAINT_VIOLATED:
            return "TIMING_CONSTRAINT_VIOLATED";

        // Serialization
        case ErrorCode::SERIALIZE_FAILED:
            return "SERIALIZE_FAILED";
        case ErrorCode::DESERIALIZE_FAILED:
        ...
        case ErrorCode::FORMAT_INVALID:
            return "FORMAT_INVALID";
        case ErrorCode::CONSTRAINT_VIOLATED:
        ...
        case ErrorCode::SYSCALL_FAILED:
            return "SYSCALL_FAILED";
        case ErrorCode::SIGNAL_ERROR:
            return "SIGNAL_ERROR";
...
struct SourceLocation {
    ...
    constexpr SourceLocation(const char* file_, const char* func_, uint32_t line_,
                             uint32_t col_ = 0) noexcept
    ...
    constexpr bool is_valid() const noexcept { return line > 0 && file[0] != '\0'; }
};
...
public:
    ...
    Error(const Error& other)
        : code_(other.code_), message_(other.message_), location_(other.location_),
    ...
    const Error* cause() const noexcept { return cause_.has_value() ? cause_->get() : nullptr; }
...
#define IPB_TRY_MSG(expr, msg)                                                       \
    do {                                                                             \
        auto _ipb_result = (expr);                                                   \
        if (IPB_UNLIKELY(_ipb_result.is_error())) {                                  \
            return ::ipb::common::err(_ipb_result.code(), msg, IPB_CURRENT_LOCATION) \
